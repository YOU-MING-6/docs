...
::mingcute:time-duration-line:: **上次更新时间：** [查看更新日志](#更新日志)  
::mingcute:board-line:: **当前版本：** ==正式版 - v2.0.0==（已固定版本号）

---

::mingcute:layout-3-line:: **项目分类：** [YM-网站与应用](/notes/#ym-网站与应用)  
::mingcute:quill-pen-line:: **遵循协议：** MIT 许可证 与 ::mingcute:share-3-line:: 转载协议 - [查看作品权限](#作品权限)  
:::

### ::mingcute:contacts-3-line:: 创作人员

到 [成员页面](/friends/) 页面查看创作人员。
...
- [VuePress-Theme-Plume](https://github.com/pengzhanbo/vuepress-theme-plume)   
  作者：pengzhanbo  
  开源项目-非商用（遵循[MIT许可证](https://github.com/pengzhanbo/vuepress-theme-plume?tab=MIT-1-ov-file)）
:::
...
<LinkCard title="作品文档 - 域名①" icon="mingcute:book-2-line" href="https://docs.youming.v6.army"></LinkCard>
<LinkCard title="作品文档 - 分发域名②" icon="mingcute:book-2-line" href="https://docs.youming.us.ci"></LinkCard>
<LinkCard title="作品文档 - 分发域名③" icon="mingcute:book-2-line" href="https://docs.youming.dpdns.org"></LinkCard>
