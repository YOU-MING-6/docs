...
permalink: /notes/协议/修改需申请.html
---

<div style="text-align: center;">
    <p style="font-size: 36px; font-weight: 650">修改需申请作品使用授权协议</p>
    <p style="font-size: 28px; font-weight: 650">非商用-修改需申请-协议继承</p>
...
本协议适用于所有标注需遵守《修改需申请作品使用授权协议》的内容（以下简称“作品”）。  
...
- 授权申请通过前：
  ...
  - 本协议的「授权后 使用权限条款」不生效
- 申请流程：
  - 通过 [反馈中心](/notes/反馈中心/) 中说明的方法申请授权
  - 等待审核；审核完成后通过邮件等方式通知结果
- 授权申请通过后：
...
- 协议继承：
  - 修改、改编、重新发布或基于作品创作的衍生内容必须继承本协议的条款（保持非商用与不可修改）。
- 禁止授权转让：
  - 禁止将本协议下的使用权转售、出租、分许可或以其他方式转让。
- 暗示背书：
  - 您可以用任何合理的方式来署名，但是不得以任何方式暗示许可人为您或您的使用背书。
