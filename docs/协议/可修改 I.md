...
permalink: /notes/协议/可修改I.html
---

<div style="text-align: center; ">
    <p style="font-size: 36px; font-weight: 650">可修改作品使用权限协议 I</p>
    <p style="font-size: 28px; font-weight: 650">商用-可修改</p>
...
本协议适用于所有标注需遵守《可修改作品使用权限协议 I》的内容（以下简称“作品”）。  
