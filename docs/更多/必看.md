...
欢迎加入我们的 [QQ频道](/notes/更多/链接.html#qq) ！

## ::mingcute:pencil-3-line:: 使用或修改作品

::: card

### ::mingcute:quill-pen-line /#64dc64:: 开源项目-商用

如下载的是一个开源项目-商用，在遵守 [《开源作品使用权限协议-商用》](/notes/协议/开源-非商用.html) 中的条款时可正常使用。
...
### ::mingcute:quill-pen-line /#64dc64:: 可修改-非商用-协议继承

如下载的是一个开源项目-非商用，在遵守 [《开源作品使用权限协议-非商用》](/notes/协议/开源-非商用.html) 中的条款时可正常使用。
...
### ::mingcute:key-2-line /#0095ff:: 修改需申请

如下载的是一个非开源项目，在遵守 [《非开源作品使用授权协议》](/notes/协议/非开源-非商用.html) 中的条款时可正常使用。

你完全可以合规地向我们 [发送授权申请](/notes/反馈中心/)，何必提心吊胆地违规发布呢？
在已发送申请后，请不定时检查你填写的邮箱，以确认是否收到审核结果。  
如果已收到审核结果，且审核结果为「通过」后，将获得 [《非开源作品使用授权协议》](/notes/协议/非开源-非商用.html) 中的权限。
...
### ::mingcute:forbid-circle-line /#ff6666:: 不可修改-非商用
