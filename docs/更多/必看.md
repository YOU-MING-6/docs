...
### ::mingcute:quill-pen-line /#40c057:: 开源项目-商业

如下载的是一个开源项目-商业，在遵守 [《开源作品使用权限协议-商业》](/notes/协议/开源-非商业.html) 中的条款时可正常使用。
...
### ::mingcute:quill-pen-line /#40c057:: 开源项目-非商业

如下载的是一个开源项目-非商业，在遵守 [《开源作品使用权限协议-非商业》](/notes/协议/开源-非商业.html) 中的条款时可正常使用。
...
如下载的是一个非开源项目，在遵守 [《非开源作品使用授权协议》](/notes/协议/非开源-非商业.html) 中的条款时可正常使用。

你完全可以合规地向我们 [发送授权申请](/notes/反馈中心/)，何必提心吊胆地违规发布呢？
在已发送申请后，请不定时检查你填写的邮箱，以确认是否收到审核结果。  
如果已收到审核结果，且审核结果为「通过」后，将获得 [《非开源作品使用授权协议》](/notes/协议/非开源-非商业.html) 中的权限。
